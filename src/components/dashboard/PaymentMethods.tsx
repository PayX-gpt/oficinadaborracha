...
import { mockPaymentMethods, formatCurrency } from "@/lib/mockDashboardData";

const PaymentMethods = () => {
  const total = mockPaymentMethods.reduce((s, m) => s + m.bruto, 0);
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="relative">
          <ResponsiveContainer width="100%" height={220}>
            <PieChart>
              <Pie data={mockPaymentMethods} cx="50%" cy="50%" innerRadius={60} outerRadius={90} dataKey="bruto" stroke="none">
